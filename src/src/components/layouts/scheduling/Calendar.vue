<template>
  <div class="text-center lg:col-start-8 lg:col-end-13 lg:row-start-1 lg:mt-4 xl:col-start-9 w-full h-1/3">
    ...
    <div class="mt-3.5 grid grid-cols-7 text-xs leading-6 text-gray-500">
      <div>M</div>
      <div>T</div>
      <div>W</div>
      <div>T</div>
    ...
    <div
      class="isolate grid grid-cols-7 gap-px rounded-lg bg-gray-200 text-sm shadow ring-1 ring-gray-200 h-[50%]"
    >
      <!--
      ...
      <button type="button" class="bg-white py-1 text-gray-900 hover:bg-gray-100 focus:z-10">
        <time
          datetime="2022-01-01"
          class="mx-auto flex h-4 w-4 items-center justify-center rounded-full"
        >1</time>
      ...
      <button
        type="button"
        class="rounded-tr-lg bg-white py-1 text-gray-900 hover:bg-gray-100 focus:z-10"
      >
        <time
          datetime="2022-01-01"
          class="mx-auto flex h-4 w-4 items-center justify-center rounded-full"
      ...
      <button
        type="button"
        class="rounded-bl-lg bg-white py-1 text-gray-900 hover:bg-gray-100 focus:z-10"
      >
        <time
          datetime="2022-01-31"
          class="mx-auto flex h-4 w-4 items-center justify-center rounded-full"
