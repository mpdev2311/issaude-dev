                ...
                <div class="mt-4 grid grid-cols-1 gap-y-6 gap-x-4 sm:grid-cols-6 space-y-1">
                    ...
                    <div class="sm:col-span-3">
                        ...
                        <div class="mt-2">
                            ...
                            v-model="healthProfessional.cep" > 
                        </div>                        
                    </div>
                        ...
                        <div class="mt-1">
                            <input  type="text" name="nome" id="nome" autocomplete="given-name" class="shadow-sm bg-gray-200 focus:ring-indigo-500 focus:border-indigo-500 block w-full sm:text-sm border border-gray-200 rounded-md" 
                                v-model="healthProfessional.cod_ibge"> 
                        </div>                        
                    </div>
                        ...
                        <div class="mt-1">
                            <input   type="text" name="nome" id="nome" autocomplete="given-name" class="shadow-sm bg-gray-200 focus:ring-indigo-500 focus:border-indigo-500 block w-full sm:text-sm border border-gray-200 rounded-md" 
                                v-model="healthProfessional.endereco"> 
                        </div>                        
                    </div>
                    ...
                    <div class="sm:col-span-1">
                        ...
                        <div class="mt-1">
                            <input type="text" name="nome" id="nome" autocomplete="given-name" class="shadow-sm bg-gray-200 focus:ring-indigo-500 focus:border-indigo-500 block w-full sm:text-sm border border-gray-200 rounded-md" 
                            v-model="healthProfessional.ncasa"> 
                        </div>                        
                    </div>
                    <div class="sm:col-span-4">
                        ...
                        <div class="mt-1">
                            <input type="text" name="nome" id="nome" autocomplete="given-name" class="shadow-sm bg-gray-200 focus:ring-indigo-500 focus:border-indigo-500 block w-full sm:text-sm border border-gray-200 rounded-md" 
                            v-model="healthProfessional.complemento_end"> 
                        </div>                        
                    </div>
                        ...
                        <div class="mt-1">
                            ...
                            v-model="healthProfessional.tipo_endereco">
                    ...
                    <div class="sm:col-span-2">
                        ...
                        <div class="mt-1">
                            <input  type="text" name="bairro" id="bairro" autocomplete="given-name" class="shadow-sm bg-gray-200 focus:ring-indigo-500 focus:border-indigo-500 block w-full sm:text-sm border border-gray-200 rounded-md" 
                                v-model="healthProfessional.bairro">
                        </div>                        
                    </div>
                        ...
                        <div class="mt-1">
                            <input type="text" name="cidade" id="cidade" autocomplete="given-name" class="shadow-sm bg-gray-200 focus:ring-indigo-500 focus:border-indigo-500 block w-full sm:text-sm border border-gray-200 rounded-md" 
                                v-model="healthProfessional.cidade">
                        </div>                        
                    </div>
...
export default defineComponent({
  ...
  setup(props) {
    ...
    let getAddressData =  async () => {     
        console.log(store.getters.healthProfessional.cep);
              await  axios.get(`https://viacep.com.br/ws/${store.getters.healthProfessional.cep}/json/`).then(response => {
                    let data = response.data;
                    console.log(data);
                    store.getters.healthProfessional.bairro = data.bairro;
                    store.getters.healthProfessional.cidade = data.localidade;
                    store.getters.healthProfessional.endereco = data.logradouro;
                    store.getters.healthProfessional.uf = data.uf;
                    store.getters.healthProfessional.cod_ibge= data.ibge
                });
        };
