                ...
                <table class="text-left w-full border-collapse">
                  ...
                  >
                    <tr class="hover:bg-gray-200">
                      <td class="py-4 px-6 border-b text-gray-700 text-lg">{{ i.rota?.id_acl_modulo }}</td>
...
import { AclModuleRoute } from '../../../../core/domain/acl/acl-modules/routes/acl-module-route'
...
export default defineComponent({
  ...
  setup() {
    ...
    const onSelectChange = (i: any) => {
      console.log(aclRouteSelected.value)
    ...
    const onFilter = () =>{
      ...
      const found = store.getters.aclProfile.permissions.filter(element => search.value === element.rota.nome );
      console.log(found)
    }
