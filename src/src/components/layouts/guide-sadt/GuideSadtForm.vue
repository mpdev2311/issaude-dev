    ...
    <div class="pt-1">
      <div class="mt-3 grid grid-cols-1 gap-y-6 gap-x-4 sm:grid-cols-6 space-y-1 lg:col-span-3  ">
        ...
        <div class="col-span-6 sm:col-span-1 m-2">
            <label for="nome" class=" flex items-center justify-center block text-sm font-medium text-gray-700">
                Tipo de Guia:
            </label>
            <div class="mt-0 max-w-5xl lg:p-4 ">
        ...
        <div class="col-span-6 sm:col-span-1">
         ...
         <div class="col-span-6 sm:col-span-1">
          <label for="last_name" class=" flex items-center justify-center block text-sm font-medium text-gray-700">
            Data Autorização:
          </label>
          <div class="mt-0 max-w-5xl lg:p-4">
