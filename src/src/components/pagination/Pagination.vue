...
// import { PaginationProps, PaginationEmits } from '../../core/domain/pagination/Pagination'
        ...
        >
          ...
          <template v-for="page in pages" :key="page">
            <RouterLink
              ...
              class="bg-white border-gray-300 text-gray-500 hover:bg-gray-50 relative inline-flex items-center px-4 py-2 border text-sm font-medium"
              :class="currentPage === page ? 'z-10 bg-indigo-50 border-indigo-500 text-indigo-600' : ''"
          ...
          <RouterLink
            ...
            class="bg-white border-gray-300 text-gray-500 hover:bg-gray-50 relative inline-flex items-center px-4 py-2 border text-sm font-medium"
            :class="currentPage === lastPage ? 'z-10 bg-indigo-50 border-indigo-500 text-indigo-600' : ''"
