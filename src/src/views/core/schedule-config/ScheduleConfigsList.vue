<template>
  <div>
    <NotificationAlert />
    <h3 class="text-gray-700 text-2xl font-semibold">Cadastro de Agenda</h3>
      ...
      <div class="mt-6 " >
        <div class="mt-4 px-4 py-5 bg-white grid grid-cols-1 gap-y-6 gap-x-4 sm:grid-cols-6 space-y-1">
            ...
            <div class="sm:col-span-2 ">
                ...
                <div class="mt-2">
                    <input type="date" pattern="\d{4}-\d{1,2}-\d{1,2}"  name="dataInicio" id="dataInicio" autocomplete="dataInicio" class=" w-40 ml-1 mr-1 text-sm text-gray-500 font-semibold py-2 px-4 rounded-r border border-gray-300 rounded-md" >
                    <div class="pointer-events-none absolute inset-y-0 right-0 flex items-center px-2 text-gray-700"></div>
                     <span>a</span>
                     <input type="date"  pattern="\d{4}-\d{1,2}-\d{1,2}" name="dataFim" id="dataFim" autocomplete="dataFim" class="w-40 ml-1 mr-1 text-sm text-gray-500 font-semibold py-2 px-4 rounded-l border border-gray-300 rounded-md" >
                    <div class="pointer-events-none absolute inset-y-0 right-0 flex items-center px-2 text-gray-700"></div>
                </div>
             </div>
             ...
             <!-- <div class="sm:col-span-1">
                <label for="nome" class="px-2 block text-sm font-medium text-gray-700">
                Data Fim<span class="text-red-700">*</span>
                </label>
                <div class="mt-1">
                     <input type="date"   name="dataFim" id="dataFim" autocomplete="dataFim" class="ml-1 mr-1 text-sm text-gray-500 font-semibold py-2 px-4 rounded-l border border-gray-300 rounded-md" >
                    <div class="pointer-events-none absolute inset-y-0 right-0 flex items-center px-2 text-gray-700"></div>
                </div>
             </div> -->
              ...
              <div class="sm:col-span-2">
                ...
                <div class="mt-1">
                    <select name="agenda" id="agenda" autocomplete="agenda" class="mt-1 block w-full py-2 px-3 border border-gray-300 bg-white rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm" 
                        >
              ...
              <div class="sm:col-span-2">
                ...
                <div class="mt-1">
                    <select name="profissional" id="profissional" autocomplete="profissional" class="mt-1 block w-full py-2 px-3 border border-gray-300 bg-white rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm" 
                       >
                        <option  v-bind:value="0"></option>
        ...
        <div class="bg-white shadow rounded-md overflow-hidden my-6">
          ...
          <!-- show message -->
            ...
            <div
              ...
              <div class="flex justify-end px-2 py-3 bg-gray-50 rounded-b-lg text-right sm:px-0 bg-gray-900">
...
export default defineComponent({
  ...
  setup(props) {
    ...
    const onEdit = (id) => {
       router.push(`/schedule_configs/${id}`)
    }
    ...
    const onCreate = () =>{
      router.push('/schedule_configs/0')
    }
