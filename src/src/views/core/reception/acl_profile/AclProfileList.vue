<template>
  <div>
    <h3 class="text-gray-700 text-2xl font-semibold">Cadastro de perfil</h3>
      ...
      <div class="mt-5">
        <div class="bg-white shadow rounded-md overflow-hidden my-6">
          <table class="text-left w-full border-collapse">
            ...
            <tbody>
              <tr v-for="i in aclProfiles" :key="i" class="hover:bg-gray-200">
          ...
          <div class="flex justify-end px-2 py-3 rounded-b-lg text-right sm:px-0 bg-gray-900">
            <button
              @click="onCreate()"
              type="button"
              class="
...
export default defineComponent({
  ...
  computed: {
    ...mapState(['aclProfiles']),
    ...mapGetters(['aclProfiles']),
  },
  ...
  setup(props) {
    ...
    const onEdit = (id) => {
      router.push(`/acl_profiles/${id}`)
    }

    const onDelete = async (i) => {
      await store.dispatch('ACL_PROFILE_STORE_DELETE_BY_ID', i.id_perfil)
    }

    const onCreate = () => {
      router.push('/acl_profiles/0')
    }
