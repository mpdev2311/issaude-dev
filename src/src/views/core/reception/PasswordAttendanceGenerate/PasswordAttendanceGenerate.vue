        ...
        <div class="mt-6">
          ...
          <div class="flex mt-4  justify-center items-center">
            <label class="inline-flex items-center">
              <input @change="onChangeCpf()" v-model="cpf" type="text" class="text-center  w-80 rounded-md w-full text-black text-lg  h-20 rounded-lg  object-cover z-40" />
            </label>
          </div>
...
export default defineComponent({
  ...
  setup() {
    ...
    onMounted(() => {
      ...
      console.log(store.getters.passwordAttendances)
    })
