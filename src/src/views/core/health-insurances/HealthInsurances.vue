                  ...
                  <div  v-if="healthInsurance.id !== 0">
                    ...
                    <div class="">
                      <div class="mt-0 align-text-top text-lg text-gray-400 font-semibold">
                       ...
                       <div class="mt-8">
                        <div v-show="step === 1">
                          <div class="text-2xl  font-bold text-center text-white bg-gray-900 leading-tight">CONVÊNIO</div>
                        </div>
                        
                        <div v-show="step === 2">
                          <div class="text-2xl font-bold text-center text-white bg-gray-900 leading-tight">IMPOSTOS</div>
                        </div>

                        <div v-show="step === 3">
                          <div class="text-2xl font-bold text-center text-white bg-gray-900 leading-tight">PARTICULARIDADES</div>
                        </div>
                        <!-- <div v-show="step === 4">
                          <div class="text-2xl font-bold text-center text-white bg-gray-900 leading-tight">PARTICULARIDADES </div>
                        </div> -->
                    ...
                    <div class=" ">
                         <div class="align-text-top m-2 text-right right-8">
                          <div class="uppercase tracking-wide text-xs font-bold text-white bg-gray-900  leading-tight text-right" v-text="`Página: ${step} - 3`"></div>
                        </div>
                        <div class="flex items-center md:w-64   mt-10">                        
                            ...
                            <div class="text-xs w-10 text-white" v-text="parseInt(step / 3 * 100) +'%'"></div>
                        </div>
                    </div>
                  </div>
                </div>
                <!-- /Top Navigation -->
                  ...
                  <div class="py-2 ">	
                    <div class="px-5 py-1 " v-show="step === 1">
                       ...
                       <HealthInsurancesStep1 />
                       <!-- <Template /> -->

                    </div>
                    <div class="px-5 py-1 " v-show="step === 2">
                        <HealthInsurancesStep2 />

                    </div>
                    <div class="px-5 py-1 " v-show="step === 3">
                      <HealthInsurancesStep3 />
                    </div>     
                    <!-- <div class="px-5 py-1 " v-show="step === 3">
                      <HealthInsurancesStep4 />
                    </div>                 -->
...
import HealthInsurancesStep1 from "../../../components/layouts/health-insurances/HealthInsurancesStep1.vue";
import HealthInsurancesStep2 from "../../../components/layouts/health-insurances/HealthInsurancesStep2.vue";
import HealthInsurancesStep3 from "../../../components/layouts/health-insurances/HealthInsurancesStep3.vue";
import HealthInsurancesStep4 from "../../../components/layouts/health-insurances/HealthInsurancesStep4.vue";
