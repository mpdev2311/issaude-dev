      ...
      <div class="mt-6" >
        <div class="rounded-lg  mt-4 px-4 py-5 bg-white grid grid-cols-1 gap-y-6 gap-x-4 sm:grid-cols-6 space-y-1">
          ...
          <div class="sm:col-span-1">
            ...
            <div class="mt-3" >
              <input v-model="inputFilter.id" type="text" name="p_consulta" id="p_consulta" autocomplete="p_consulta" class="w-full xl:w-40 ml-2 text-sm bg-gray-100 text-gray-500 font-semibold py-2 px-4 rounded-r border border-gray-300 rounded-md transition duration-500 ease-in-out" >
          ...
          <div class="sm:col-span-2 m-2">
            ...
            <div class="mt-2 max-w-5xl ">
              <input type="text" name="first_name" autocomplete="given-name" class="shadow-sm focus:ring-indigo-500 bg-gray-100 focus:border-indigo-500 block w-full sm:text-sm border border-gray-200 rounded-md transition duration-500 ease-in-out ">
            </div>
          </div>
          ...
          <div class="sm:col-span-2 m-2">
            ...
            <div class="mt-1">
              <select autocomplete="agenda" class="mt-1 block w-full py-2 px-3 border border-gray-300 bg-gray-100 bg-white rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm transition duration-500 ease-in-out">
