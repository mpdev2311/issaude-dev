                  ...
                  <div  v-if="true">
                    ...
                    <div class="">
                      <div class="mt-0 align-text-top text-lg text-gray-400 font-semibold">
                       ...
                       <div class="mt-8">
                        <div v-show="step === 1">
                          <div class="text-2xl  font-bold text-center text-white bg-gray-900 leading-tight">Cadastro de módulos - rotas</div>
                        </div>
                        
                        <div v-show="step === 2">
                          <div class="text-2xl font-bold text-center text-white bg-gray-900 leading-tight"></div>
                        </div>
...
import AclModuleRoutesStep1 from "../../../../components/layouts/management-and-permission/acl-module-routes/AclModuleRoutesStep1.vue"
...
export default defineComponent({
  ...
  setup(props) {
    ...
    const onCreate = async () =>{
         ...
         router.push('/acl_module_routes/0')
      
    }
   const onCancel = async() =>{
     router.push('/acl_module_routes')
   }
