                  ...
                  <div  v-if="true">
                    ...
                    <div class="">
                      <div class="mt-0 align-text-top text-lg text-gray-400 font-semibold">
                       ...
                       <div class="mt-8">
                        <div v-show="step === 1">
                          <div class="text-2xl  font-bold text-center text-white bg-gray-900 leading-tight">Acesso a agenda de consulta</div>
                        </div>
                        
                        <div v-show="step === 2">
                          <div class="text-2xl font-bold text-center text-white bg-gray-900 leading-tight">Tabelas</div>
                        </div>
                    ...
                    <div class=" ">
                        ...
                        <div class="flex items-center md:w-64   mt-10">                        
                            ...
                            <div class="text-xs w-10 text-white" v-text="parseInt(step / 1 * 100) +'%'"></div>
                        </div>
                    </div>
                  </div>
                </div>
...
import SchedulePermissionsStep1 from "../../../../components/layouts/management-and-permission/schedule-permissons/SchedulePermissionsStep1.vue"
...
export default defineComponent({
  ...
  setup(props) {
    ...
    const onCreate = async () =>{
         ...
         router.push('/schedule_permission/0')
      
    }
   const onCancel = async() =>{
     router.push('/schedule_permission')
   }
