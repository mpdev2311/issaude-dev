      ...
      <div class="mt-6">
        <div class="bg-white shadow rounded-md overflow-hidden my-6 w-10/12/">
          <table class="text-left w-full border-collapse">
                   ...
                   <Dropdown class="lg:mr-10">
                          <template #content="{ closeDropDown }">
                            <button
                              ...
                              "
                              class="text-left text-gray-700 block px-4 py-2 text-sm hover:bg-gray-100 w-full"
                              role="menuitem"
                              tabindex="0"
                              id="menu-item-0"
                            >Dados do paciente</button>
                            <button
                              @click="
                                () => {
                              ...
                              tabindex="0"
                              id="menu-item-0"
                            >Detalhes do Agendamento</button>
                          </template>
                        </Dropdown>
                </th>
              </tr>
            ...
            <tbody>
              <tr
                v-for=" i in guideManagements.content"
                :key="i"
...
export default defineComponent({
  ...
  setup(props) {
    ...
    onMounted(async () => {
      ...
      console.log(store.getters.guideManagements);
    })
