                  ...
                  <div  v-if="provider.id !== 0">
                    ...
                    <div class="">
                      <div class="mt-0 align-text-top text-lg text-gray-400 font-semibold">
                       ...
                       <div class="mt-8">
                        <div v-show="step === 1">
                          <div class="text-2xl  font-bold text-center text-white bg-gray-900 leading-tight">Fornecedores</div>
                        </div>
                        
                        <div v-show="step === 2">
                          <div class="text-2xl font-bold text-center text-white bg-gray-900 leading-tight">Dados Fiscais</div>
                        </div>
                    ...
                    <div class=" ">
                         <div class="align-text-top m-2 text-right right-8">
                          <div class="uppercase tracking-wide text-xs font-bold text-white bg-gray-900  leading-tight text-right" v-text="`Página: ${step} - 2`"></div>
                        </div>
                        <div class="flex items-center md:w-64   mt-10">                        
                            ...
                            <div class="text-xs w-10 text-white" v-text="parseInt(step / 2 * 100) +'%'"></div>
                        </div>
                    </div>
                  </div>
                </div>
...
import ProvidersStep1 from "../../../components/layouts/providers/ProvidersStep1.vue";
import ProvidersStep2 from "../../../components/layouts/providers/ProvidersStep2.vue";
...
export default defineComponent({
  ...
  store.dispatch('PROVIDERS_STORE_SET_BLANK', provider.value)
  ...
  onMounted(async () => {
       const { id } = router.currentRoute.value.params
        ...
        if(id !== '0'){
          ...
          await store.dispatch('PROVIDERS_STORE_LOAD_BY_ID', id)          
          

        }else{
          await store.dispatch('PROVIDERS_STORE_SET_BLANK', provider.value)
        }
    });
    ...
    const onSave = async () => {
      await store.dispatch('PROVIDERS_STORE_SAVE')
    };
