<template>
  <div>
   ...
   <div class="mt-4 flex flex-col sm:flex-row">
         ...
         <button class="text-sm bg-gray-800 hover:bg-gray-900 text-gray-50 font-semibold  px-5 rounded-r">
              <span class="flex justify-end px-4 py-0">  
              <svg class="h-5 w-4" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z" />
              </svg> Excel
      ...
      <div class="mt-6">
        <div class="block relative mt-1 ml-2 mr-2 bg-white shadow rounded-lg">
               ...
               <Finder class="w-60 mt-1 ml-2 mr-2" :id_object="healthPlan.id_convenio" :object_name="healthPlan.nome_convenio" :data="providers" :selectedHandle="onSelectChange"/>
          ...
          <table class="text-left w-full border-collapse">
            ...
            <tbody>
              <tr
                ...
                :key="i"
                v-show="healthPlan.nome_convenio == '' || healthPlan.nome_convenio == i.nome_convenio"
