  ...
  <div>
    ...
    <div class="mt-19  bg-gray-300 hover:bg-gray-200  py-5 px-5 border-b-4 border-gray-400 hover:border-gray-500 rounded">
                  ...
                  <div >
                    ...
                    <div class="">
                      <div class="mt-0 align-text-top text-lg text-gray-400 font-semibold">
                       ...
                       <div class="mt-8 ">
                        <div v-show="step === 1">
                          <div class="text-2xl  font-bold text-center text-white bg-gray-900 leading-tight">Cadastro de planos</div>
                        </div>
                  ...
                  <div class="py-2">	
                    <div class="h-full w-full px-5 py-1" v-show="step === 1">
                       ...
                       <form class="">
                        ...
                        <div class="px-4  flex-auto" >
                                ...
                                <div class="pt-1">                        
                                <div class="mt-4 grid grid-cols-1 gap-y-1 gap-x-8 sm:grid-cols-6 space-y-1">
                                ...
                                <div class="mt-1">
                                  <div class="sm:col-span-3">
                                    ...
                                    <div>
                                    <Finder :id_object="healthPlan.id_convenio" :object_name="healthPlan.nome_convenio" v-bind:data="providers" v-bind:selectedHandle="onSelectChange" />
                                    </div>
                                  </div>
                                </div>
                                ...
                                <div class="mt-1">
                                    <select type="text" name="first_name" id="first_name" autocomplete="given-name" class="shadow-sm bg-gray-200 focus:ring-indigo-500 focus:border-indigo-500 block w-full sm:text-sm border border-gray-200 rounded-md"
                                    v-model="healthPlan.id_tabela_med"
                                    
                                    >
                                        <option :value="0">selecione</option>
                                        <option v-for="i in tableNames" :key="i" v-show="i.id_tipo == 1" :value="i.id" >{{i.codigo}} - {{i.descri}}</option>
                                    </select>
                                </div>
                                </div>   
                                ...
                                <div class="mt-1">
                                    ...
                                    > 
                                        <option :value="0">selecione</option>
                                        <option v-for="i in tableNames" :key="i" v-show="i.id_tipo == 3" :value="i.id" >{{i.codigo}} - {{i.descri}}</option>
                                    </select>
                                </div>
                                </div>
                                ...
                                <div class="mt-1">
                                    ...
                                    >
                                        <option :value="0">selecione</option>
                                        <option v-for="i in tableNames" :key="i" v-show="i.id_tipo == 4" :value="i.id" >{{i.codigo}} - {{i.descri}}</option>
                                    </select>
                                </div>
                                </div>
                                ...
                                <div class="mt-1 mb-3">
                                    ...
                                    >
                                        <option :value="0">selecione</option>
                                        <option v-for="i in tableNames" :key="i" v-show="i.id_tipo == 2" :value="i.id" >{{i.codigo}} - {{i.descri}}</option>
                                    </select>
                                </div>
                                </div>
                    ...
                    <div class="py-1 flex-auto">
                        ...
                        <div class="px-4 py-2 flex-auto">
                                ...
                                <div class="mt-1">
                                    <input  type="number" name="orgao_documento" id="orgao_documento" autocomplete="given-name" class="shadow-sm bg-gray-200 focus:ring-indigo-500 focus:border-indigo-500 block w-full sm:text-sm border border-gray-200 rounded-md"
                                ...
                                <div class="mt-1">
                                    ...
                                    >
                                        <option :value="0">selecione</option>
                                        <option v-for="i in typeGuides" :key="i" v-show="i.servico_tipo == 1" :value="i.id" >{{i.nome}}</option>
                                    </select>
                                </div>
                                </div>
                                ...
                                <div class="mt-1">
                                    ...
                                    >
                                        <option :value="0">selecione</option>
                                        <option v-for="i in typeGuides" :key="i" v-show="i.servico_tipo == 2" :value="i.id" >{{i.nome}}</option>
                                    </select>
                                </div>
                                </div>
                                ...
                                <div class="mt-1">
                                    ...
                                    >
                                        <option :value="0">selecione</option>
                                        <option v-for="i in typeGuides" :key="i" v-show="i.servico_tipo == 3" :value="i.id" >{{i.nome}}</option>
                                    </select>
                                </div>
                                </div>
                                    </div>
      ...
      <div class=" mx-auto   px-4 py-3 rounded-b-lg text-right sm:px-6 bg-gray-900">
              ...
              <button @click="onCancel()" type="button" class="sm:space-x-0 sm:inline-flex sm:justify-items-center space-x-2 inline-flex justify-center py-2 px-4 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-red-600 hover:bg-red-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 mx-2">
                  Fechar
               ...
               <button @click="onSave()" type="button" class="sm:space-x-0 sm:inline-flex sm:justify-items-center space-x-2 inline-flex justify-center py-2 px-4 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-green-600 hover:bg-green-500 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 mx-2">
                  Salvar
     ...
     <!-- show message -->
    <div :class="{'bg-red-200': bgRed, 'bg-green-200' : bgGreen}" v-if="showMessage" class="flex justify-center px-4 py-3 text-right sm:px-6 bg-green-200">
                  Usuário salvo com sucesso! <a href="#" @click="onCloseMessage"><svg class="h-6 w-6" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor"><path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zM8.707 7.293a1 1 0 00-1.414 1.414L8.586 10l-1.293 1.293a1 1 0 101.414 1.414L10 11.414l1.293 1.293a1 1 0 001.414-1.414L11.414 10l1.293-1.293a1 1 0 00-1.414-1.414L10 8.586 8.707 7.293z" clip-rule="evenodd" /></svg></a>
    </div>   
    <!-- show message -->
