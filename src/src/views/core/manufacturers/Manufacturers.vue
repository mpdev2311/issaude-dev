                  ...
                  <div  v-if="manufacturer.id !== 0">
                    ...
                    <div class="">
                      <div class="mt-0 align-text-top text-lg text-gray-400 font-semibold">
                       ...
                       <div class="mt-8">
                        <div v-show="step === 1">
                          <div class="text-2xl  font-bold text-center text-white bg-gray-900 leading-tight">Fabricantes</div>
                        </div>                        
                    ...
                    <div class=" ">
                         <div class="align-text-top m-2 text-right right-8">
                          <div class="uppercase tracking-wide text-xs font-bold text-white bg-gray-900  leading-tight text-right" v-text="`Página: ${step} - 1`"></div>
                        </div>
...
import ManufacturersStep1 from "../../../components/layouts/manufacturers/ManufacturersStep1.vue";
...
export default defineComponent({
  ...
  store.dispatch('MANUFACTURERS_STORE_SET_BLANK', manufacturer.value)
  ...
  onMounted(async () => {
       const { id } = router.currentRoute.value.params
        ...
        if(id !== '0'){
          ...
          await store.dispatch('MANUFACTURERS_STORE_LOAD_BY_ID', id)          
          

        }else{
          await store.dispatch('MANUFACTURERS_STORE_SET_BLANK', manufacturer.value)
        }
    });
    ...
    const onSave = async () => {
      await store.dispatch('MANUFACTURERS_STORE_SAVE')
    };
