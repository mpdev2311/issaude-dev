import AclProfileCorporationService from "../../../services/acl/acl-profile-corporation/acl-profile-corporation-service"
...
export default {
    ...
    actions: {
        ...
        ACL_PROFILE_CORPORATION_STORE_LOAD: async ({ commit, state }) => {
            ...
            console.log(state.aclProfileCorporations)
        },
        ...
        ACL_PROFILE_CORPORATION_STORE_LOAD_SELECTED: async ({ commit, state }, params: any) => {
            ...
            console.log(state.aclProfileCorporationSelected)
        },
        ...
        ACL_PROFILE_CORPORATION_STORE_SET_BLANK: async ({ commit }, aclProfileCorporations: AclProfileCorporation) => {
        ...
        ACL_PROFILE_CORPORATION_STORE_SAVE: async ({ getters, dispatch, state }, data: any) => {
            ...
            await AclProfileCorporationService.update(data, param)
                .then(async (response) => {
