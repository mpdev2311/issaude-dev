...
export default defineComponent({
  ...
  computed: {
    ...mapState(['unitMeasure']),
    ...mapGetters(['unitMeasure']),
  },
  ...
  setup(props) {
    ...
    onMounted(async () => {
      ...
      else await store.dispatch('UNIT_STORE_SET_BLANK', unitMeasure.value)
    })
