          ...
          <div class="sm:col-span-2">
            ...
            <div class="mt-2">
              <input
                ...
                class="w-40 ml-1 mr-1 text-sm text-gray-500 font-semibold py-2 px-4 rounded-r border border-gray-300 rounded-md"
              />
              <div
                class="pointer-events-none absolute inset-y-0 right-0 flex items-center px-2 text-gray-700"
              ></div>
              ...
              <input
                ...
                class="w-40 ml-1 mr-1 text-sm text-gray-500 font-semibold py-2 px-4 rounded-l border border-gray-300 rounded-md"
              />
              <div
                class="pointer-events-none absolute inset-y-0 right-0 flex items-center px-2 text-gray-700"
              ></div>
      ...
      <div class="mt-6">
        <div class="bg-white shadow rounded-md overflow-hidden my-6">
          <table class="text-left w-full border-collapse">
            ...
            <tbody>
              <tr v-for="i in scheduleConfigs" :key="i" class="hover:bg-gray-200">
          ...
          <div
            class="flex justify-end px-2 py-3 bg-gray-50 rounded-b-lg text-right sm:px-0 bg-gray-900"
          >
            <button
              @click="onCreate()"
              type="button"
...
export default defineComponent({
  ...
  computed: {
    ...mapState(['healthProfessionals', 'scheduleConfigs', 'scheduleNames']),
    ...mapGetters(['healthProfessionals', 'scheduleConfigs', 'scheduleNames']),
  },
