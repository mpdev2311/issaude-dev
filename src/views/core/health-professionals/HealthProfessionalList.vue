<template>
  <div>
    <h3 class="text-gray-700 text-2xl font-semibold">Cadastro de Profissionais</h3>
      ...
      <div class="mt-6">
        <div class="bg-white shadow rounded-md overflow-hidden my-6">
          <table class="text-left w-full border-collapse">
            ...
            <tbody>
              <tr v-for="i in healthProfessionals" :key="i" class="hover:bg-gray-200">
...
export default defineComponent({
  ...
  computed: {
    ...mapState(['healthProfessionals']),
    ...mapGetters(['healthProfessionals']),
  },
  ...
  setup(props) {
    ...
    const onEdit = (id) => {
      router.push(`/health_professionals/${id}`)
    }

    const onDelete = async (i) => {
      await store.dispatch('HEALTH_PROFESSIONAL_STORE_DELETE_BY_ID', i.id)
    }

    const onCreate = () => {
      router.push('/health_professionals/0')
    }
