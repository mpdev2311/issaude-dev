...
import TargetAudienceFormComponent from '../../../components/layouts/target-audience/TargetAudienceFormComponent.vue'
...
export default defineComponent({
  ...
  computed: {
    ...mapState(['targetAudience']),
    ...mapGetters(['targetAudience']),
  },
  ...
  setup(props) {
    ...
    const onSave = async () => {
      ...
      router.push('/target-audience')
      await store.dispatch('MESSAGE_STORE_SUCCESS_PUSH', 'Target audience salva com sucesso!')
    }
