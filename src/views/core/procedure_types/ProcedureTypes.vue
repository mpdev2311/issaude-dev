...
export default defineComponent({
  ...
  computed: {
    ...mapState(['procedureType']),
    ...mapGetters(['procedureType']),
  },
  ...
  setup(props) {
    ...
    onMounted(async () => {
      ...
      else await store.dispatch('PROCEDURE_TYPE_STORE_SET_BLANK', procedureType.value)
    })
