                      ...
                      <tr v-show="i.haveAcess == false" class="hover:bg-gray-200">
                        <td class="py-4 px-8 border-b text-gray-700 text-lg">
                          <button
                            ...
                            class="px-3 py-1 bg-green-600 text-white rounded-md text-sm hover:bg-green-200 focus:outline-none"
                          >
                            <svg
                      ...
                      <tr v-show="j.haveAcess == true" class="hover:bg-gray-200">
                        ...
                        <td class="py-4 px-8 border-b text-gray-700 text-lg">
                          <button
                            ...
                            class="px-3 py-1 bg-red-600 text-white rounded-md text-sm hover:bg-red-300 focus:outline-none"
                          >
                            <svg
                              xmlns="http://www.w3.org/2000/svg"
                              class="h-6 w-6"
