      ...
      <main class="flex-1 relative z-0 overflow-y-hidden focus:outline-none xl:order-last">
        ...
        <div class="relative inset-0 pb-2 px-0">
          <div>
            ...
            >
              <!--  -->
              <Table v-if="billsSadts !== 0" :data="billsSadts.content" :columns="columnsTab">
              ...
              >
                <Pagination
                  :item-per-page="billsSadts.size"
                  :total-items="billsSadts.totalElements"
...
export default defineComponent({
  ...
  methods: {
    ...mapMutations(['billsSadts', 'guideManagements', 'localAccess', 'providers', 'guidetypes']),
  },
  computed: {
    ...mapState(['billsSadts', 'guideManagements', 'localAccess', 'providers', 'guidetypes']),
    ...mapGetters(['billsSadts', 'guideManagements', 'localAccess', 'providers', 'guidetypes']),
  },
