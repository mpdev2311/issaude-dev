    ...
    <div class="space-y-8 divide-y divide-gray-200">
      <div class="pt-1">
        <div class="mt-3 grid grid-cols-1 gap-y-6 gap-x-4 sm:grid-cols-6 space-y-1 lg:col-span-3">
          ...
          <div class="lg:pl-3 col-span-6 lg:pr-4 sm:col-span-2">
          ...
          <div class="col-span-6 sm:col-span-2">
            ...
            <div class="lg:pl-4">
              <select
                ...
                name="local"
                autocomplete="local"
                class="mt-3 max-w-5xl block w-full py-2 px-3 border border-gray-300 bg-gray-100 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm transition duration-500 ease-in-out"
              >
                <option v-bind:value="0">Selecione</option>
          ...
          <div class="col-span-6 lg:pl-4 sm:col-span-2">
            <label for="local" class="block text-sm font-medium text-gray-700">
          ...
          <div class="col-span-6 sm:col-span-1">
            ...
            <div class="mt-3 max-w-5xl lg:p-4">
              <input
          ...
          <div class="col-span-6 sm:col-span-2">
            ...
            <div class="mt-6 max-w-5xl">
              ...
              >
               ...
               <div class="col-span-6 lg:pr-3 sm:col-span-1">
            <label for="local" class=" block text-sm font-medium text-gray-700">
...
export default defineComponent({
  ...
  setup(props) {
    ...
    const formatGuideDateReverseFields = async () => {
      ...
      store.getters.guideManagement.data_solicitacao = formatDateReverse(
        store.getters.guideManagement.data_solicitacao
      )

      store.getters.guideManagement.data_autorizacao = formatDateReverse(
        store.getters.guideManagement.data_autorizacao
      )
    ...
    const onSave = async () => {
      store.getters.guideManagement.tipo = 3
      store.getters.guideManagement.emissao = formatDate(store.getters.guideManagement.emissao)
      store.getters.guideManagement.data_solicitacao = formatDate(
        store.getters.guideManagement.data_solicitacao
      )

      store.getters.guideManagement.data_autorizacao = formatDate(
        store.getters.guideManagement.data_autorizacao
      )
      store.getters.guideManagement.validade_senha = formatDate(
        store.getters.guideManagement.validade_senha
      )
