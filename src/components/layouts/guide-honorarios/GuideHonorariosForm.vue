        ...
        <div class="mt-3 grid grid-cols-1 gap-y-6 gap-x-4 sm:grid-cols-6 space-y-1 lg:col-span-3">
          <div class="col-span-6 sm:col-span-2">
            ...
            <div class="mt-4 max-w-5xl">
              <Combobox :options="state.patients" label="nome" v-model="guideManagement.id_paciente" @change-search="onSearchPatient" hidden-icon>
            ...
            <div class="mt-3">
              ...
              >
                <option value="0">Selecionar</option>
                  ...
                  <option
                    v-for="i in localAccess.content"
                    :key="i"
                    :value="2"
