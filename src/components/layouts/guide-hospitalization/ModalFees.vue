<template>
  ...
  >
    <template #body>
      ...
      <!-- <div class="mt-6 pl-1 grid grid-cols-12 gap-4">
...
import { Bill } from '@domain/guide-sadt/bills/bill-model'
import Combobox from '@components/combobox/Combobox.vue'
import AmbProcedureService from '@domain/amb-procedure/amb-procedure-service'
