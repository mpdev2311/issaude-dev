<template>
  <header
    class="flex justify-between items-center py-4 px-6 bg-white border-b-2 border-green-600 shadow-md"
  >
   <div class="flex items-center">
      <button
        @click="menu.handleMenu(!menu.menuIsOpen)"
    ...
    <div class="flex items-center">
      ...
      <div class="relative">
        <button
          ...
          class="relative z-0 block h-10 w-10 rounded-full overflow-hidden shadow focus:outline-none"
        >
          <img
