      ...
      <div class="px-4 py-1 flex-auto">
        <div class="pt-1">
          <div class="mt-0 grid grid-cols-1 gap-y-6 gap-x-4 sm:grid-cols-6 space-y-1">
            ...
            <div class="sm:col-span-2">
              <label for="apelido" class="block text-sm font-medium text-gray-700"> CNPJ </label>
              <div class="mt-2">
                <input
                  type="text"
                  name="apelido"
            ...
            <div class="sm:col-span-4">
              ...
              <div class="">
                <span class="relative z-0 inline-flex shadow-sm rounded-md">
                  ...
                  <button
                    @click.prevent="onOpenModal('/companies/', healthInsurance.id_empresa)"
                    type="button"
        ...
        <div class="px-4 py-2 flex-auto">
          <div class="pt-1">
            <div class="mt-2 grid grid-cols-1 gap-y-6 gap-x-4 sm:grid-cols-6 space-y-1">
              ...
              <div class="sm:col-span-1">
                <label for="nome" class="block text-sm font-medium text-gray-700"> Telefone </label>
                <div class="mt-2">
                  <input
                    type="text"
                    name="nome"
...
export default defineComponent({
  ...
  computed: {
    ...mapState(['companies', 'healthInsurance']),
    ...mapGetters(['companies', 'healthInsurance']),
  },
  ...
  setup(props) {
    ...
    let getAddressData = async () => {
      await axios
        .get(`https://viacep.com.br/ws/${store.getters.healthInsurance.cep}/json/`)
        .then((response) => {
