              ...
              <div class="pt-1">
                <div class="mt-6 grid grid-cols-1 gap-y-6 gap-x-4 sm:grid-cols-6 space-y-1">
                  ...
                  <div class="sm:col-span-3">
                    ...
                    <div class="mt-1">
                      <select
                        v-model="stockName.tipo"
                        id="tipo"
                        name="tipo"
                        class="mt-1 block w-full py-2 px-3 border border-gray-300 bg-white rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm"
                      >
                        <option v-for="i in stockTypes" :key="i" :value="i.id">
                          {{ i.id }}{{ i.nome }}
                        </option>
                      </select>
                    </div>
...
export default defineComponent({
  ...
  computed: {
    ...mapState(['stockName', 'stockTypes', 'stockType']),
    ...mapGetters(['stockName', 'stockTypes', 'stockType']),
  },
