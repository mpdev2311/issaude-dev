        ...
        <div class="p-6 max-w-sm w-full bg-white shadow-md rounded-md">
          ...
          <div class="mt-6">
            ...
            <button
              ...
              type="button"
              class="text-center bg-green-600 rounded-md w-full text-white text-lg hover:bg-green-500 h-20 object-cover z-40"
            >
              CONSULTA
            </button>
            <button
              ...
              type="button"
              class="text-center bg-green-600 rounded-md w-full text-white text-lg hover:bg-green-500 mt-2 h-20 object-cover z-40"
            >
              EXAMES
            </button>
          </div>
