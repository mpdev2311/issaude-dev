        ...
        <div class="mt-6">
          ...
          <div class="flex mt-4 justify-center items-center">
            <label class="inline-flex items-center">
              <input
                ...
                v-model="cpf"
                type="text"
                class="text-center w-80 rounded-md text-black text-lg h-20 object-cover z-40"
              />
            </label>
          </div>
          ...
          <div class="flex justify-center items-center">
            <button
              @click="create()"
              type="button"
              class="text-center mt-2 bg-green-600 rounded-md w-full text-white text-lg hover:bg-indigo-500 h-20 object-cover z-40"
            >
              ATENDIMENTO NORMAL
            </button>
          </div>
          ...
          <div class="flex justify-center items-center">
            <button
              @click="create()"
              type="button"
              class="text-center bg-indigo-600 rounded-md w-full text-white text-lg hover:bg-indigo-500 mt-2 h-20 object-cover z-40"
            >
