...
export default defineComponent({
  ...
  computed: {
    ...mapState(['receiptType']),
    ...mapGetters(['receiptType']),
  },
  ...
  setup(props) {
    ...
    onMounted(async () => {
      ...
      else await store.dispatch('RECEIPT_TYPE_STORE_SET_BLANK', receiptType.value)
    })
