...
import ProviderStep1 from '@components/layouts/provider/ProviderStep1.vue'
import ProviderStep2 from '@components/layouts/provider/ProviderStep2.vue'
...
export default defineComponent({
  ...
  setup(props) {
    ...
    onMounted(async () => {
      ...
      if (id !== '0') {
        await store.dispatch('PROVIDER_STORE_LOAD_BY_ID', id)
      } else {
