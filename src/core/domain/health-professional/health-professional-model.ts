...
export interface RequestHealthProfessional {
  page?: number
  size?: number
  nome: string
  id_corp?: number
...
export class RequestHealthProfessional implements RequestHealthProfessional {
  constructor(
    page: number,
    size: number,
    nome: string,
    ...
    this.nome = nome
    this.id_corp = idCorp
    this.nao_atende = nao_atende
    this.id_tipo_prestador = id_tipo_prestador
    this.do_corpo_clinico = do_corpo_clinico
  }
}
