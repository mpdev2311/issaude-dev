                    ...
                    <div class="flex items-center md:w-64 mt-10">
                      <div class="w-full bg-white rounded-full mr-2">
                        <div
                          ...
                          :style="'width: ' + parseInt((step / 6) * 100) + '%'"
                        ></div>
                      </div>
                      <div
                        class="text-xs w-10 text-white"
                        v-text="parseInt((step / 5) * 100) + '%'"
                      ></div>
                    </div>
                  </div>
                </div>
...
import HealthProfessionalStep1 from '@components/layouts/health-professional/HealthProfessionalStep1.vue'
import HealthProfessionalStep2 from '@components/layouts/health-professional/HealthProfessionalStep2.vue'
import HealthProfessionalStep3 from '@components/layouts/health-professional/HealthProfessionalStep3.vue'
import HealthProfessionalStep4 from '@components/layouts/health-professional/HealthProfessionalStep4.vue'
import HealthProfessionalStep5 from '@components/layouts/health-professional/HealthProfessionalStep5.vue'
import { TargetAudience } from '@domain/target-audience/target-audience-model'
import { Language } from '@domain/language/language-model'
    ...
    onMounted(async () => {
      ...
      if (router.currentRoute.value.params.id !== '0') {
        await store.dispatch(
          'HEALTH_PROFESSIONAL_STORE_LOAD_BY_ID',
      ...
      } else await store.dispatch('HEALTH_PROFESSIONAL_STORE_SET_BLANK', healthProfessional.value)
    })
