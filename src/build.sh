...
docker build -t registry.digitalocean.com/is-saude-containers/is-saude-front:v1.0.2 . --no-cache
docker push registry.digitalocean.com/is-saude-containers/is-saude-front:v1.0.2